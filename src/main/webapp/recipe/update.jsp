...
<FORM name='frm' method='POST' action='./update.do' class="form-horizontal" enctype="multipart/form-data">
  ...
  <div class="recipe_container_all">
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;꿀을 조금 넣어주세요 ▷ 꿀이 없는 경우, 설탕 1스푼으로 대체 가능합니다.<br><br>
      ...
      <div id="recipe_seq"> <!-- 본내용 총 DIV. append용 -->
        <div id="recipe_seq_content" style="width:80%; height:100px;"> <!-- 본내용 -->
          ...
          <div class="col-sm-6">
            <textarea placeholder="예)고기가 반쯤 익어갈 때 양파를 함께 볶아요." id="contents0" name="contents0" class="form-control" style="background-color:#F5F5F5;" rows="3">${contents0 }</textarea>
          </div>
    ...
    <DIV class="content_bottom_menu" style="padding-right: 20%;">
      <button type="button" id="btn_update" style="background-color:white; padding:10px; color:#ffbb00; border:solid 1px #ffbb00;">수정</button>
