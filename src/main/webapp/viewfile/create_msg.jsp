  ...
  <fieldset class='fieldset_basic'>
    <UL>
      ...
      <LI class='li_none'>
        <br>
        <button type='button' 
                    onclick="location.href='./create.do?p_no=${param.p_no }'"
                    class="btn btn-info">파일 계속 업로드</button>
        <button type='button' 
                    onclick="location.href='../product/read.do?p_no=${param.p_no }'"
                    class="btn btn-info">업로드된 파일 확인</button>                    
        <button type='button' 
                    onclick="location.href='../product/read.do?p_no=${param.p_no }'"
                    class="btn btn-info">글 조회</button>      
        <button type='button' 
                    onclick="location.href='../product/list.do?goryno=${param.goryno}'"
