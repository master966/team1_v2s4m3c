...
<body>
  ...
  <form name='frm' id='frm' method='POST' action='./create.do' class="form-horizontal">
	    ...
	    <div class="form-group">
	      <label for="stateno" class="col-md-2 control-label" style='font-size: 0.9em;'>배송 상태 번호</label>
	      <div class="col-md-10">
	        <input type='text' class="form-control" name='stateno' id='stateno' value='' 
	          required="required" style='width: 30%;' placeholder="1~5 입력 " autofocus="autofocus">
	      </div>
	    </div>
    
    <div class="form-group">
      <label for="receiver" class="col-md-2 control-label" style='font-size: 0.9em;'>수령인</label>
      <div class="col-md-10">
        <input type='text' class="form-control" name='receiver' id='receiver' value='' 
          required="required" style='width: 30%;' placeholder="수령자 이름" autofocus="autofocus">
      </div>
    </div>

    <div class="form-group">
      <label for="contact" class="col-md-2 control-label" style='font-size: 0.9em;'>연락처</label>
      <div class="col-md-10">
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control" name='zipcode' id='zipcode' value='' style='width: 30%;' placeholder="우편번호">
    ...
    <div class="form-group">
      ...
      <div class="col-md-10"> 
        <input type='text' class="form-control" name='address1' id='address1' value='' style='width: 80%;' placeholder="주소">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control" name='address2' id='address2' value='' style='width: 80%;' placeholder="상세 주소">
      </div>
    </div>
