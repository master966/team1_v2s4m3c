...
<jsp:include page="/menu/top.jsp" flush='false' />
  ...
  <FORM name='frm' id='frm' method='POST' action='./passwd_update.do' 
    ...
    <div class="form-group">
      <label class="col-md-6 control-label" style="font-size: 0.9em;">현재 패스워드</label>    
      <div class="col-md-6">
        <input type='password' class="form-control input-lg" name='current_passwd' 
    ...
    <div class="form-group">
      <label class="col-md-6 control-label" style="font-size: 0.9em;">새로운 패스워드</label>    
      <div class="col-md-6">
    ...
    <div class="form-group">
      <label class="col-md-6 control-label" style="font-size: 0.9em;">새로운 패스워드 확인</label>    
      <div class="col-md-6">
