...
<jsp:include page="/menu/top.jsp" flush='false' />
  ...
  <FORM name='frm' id='frm' method='POST' action='./update.do' 
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control" name='email' id='email' 
                   value='${membersVO.email }' required="required" style='width: 30%;' placeholder="이메일">
      </div>
    </div>   
    ...
    <div class="form-group">
      <label class="col-md-2 control-label" style='font-size: 0.9em;'>생년월일</label>    
      <div class="col-md-10">
        <input type='text' class="form-control" name='birth' id='birth' 
                   value='${membersVO.birth }' required="required" style='width: 30%;' placeholder="생년월일">
      </div>
    </div> 
