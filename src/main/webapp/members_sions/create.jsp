 ...
 <!-- Modal 알림창 시작 -->
  ...
  <FORM name='frm' id='frm' method='POST' action='./create.do' class="form-horizontal">
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='mname' id='mname' 
                   value='아무개' required="required" style='width: 30%;' placeholder="성명">
      </div>
    </div>   
    ...
    <div class="form-group">
      ...
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='nickname' id='nickname' 
                   value='김개발자' required="required" style='width: 30%;' placeholder="닉네임">
      </div>
    </div>
    
    <div class="form-group">
      <label for="nickname" class="col-md-2 control-label">이메일*</label>    
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='email' id='email' 
                   value='222@naver.com' required="required" style='width: 30%;' placeholder="이메일">
      </div>
    </div>
    ...
    <div class="form-group">
      <label for="nickname" class="col-md-2 control-label">생일*</label>    
      <div class="col-md-10">
        <input type='text' class="form-control input-md" name='birth' id='birth' 
                   value='2020-01-01' required="required" style='width: 30%;' placeholder="생년월일">
      </div>
    </div>
