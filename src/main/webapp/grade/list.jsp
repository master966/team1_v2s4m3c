...
<jsp:include page="/team1_menu/topindex.jsp"  />
  ...
  <DIV id='panel_create' style='padding: 10px 0px 10px 0px; background-color: #F9F9F9; width: 100%; text-align: center;'>
    <FORM name='frm_create' id='frm_create' method='POST' 
      ...
      <label>등급 번호</label>
      <input type='number' name='gradeno' value='1' required="required" 
                min='1' max='1000' step='1' style='width: 5%;'>
        
      <label>등급 이름</label>
      <input type='text' name='gname' value='' required="required" style='width: 20%;'>
      
      <label>적립률</label>
      <input type='number' name='accum' value='0.05' required="required" 
