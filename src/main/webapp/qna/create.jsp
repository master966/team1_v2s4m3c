...
<FORM class="form-horizontal" name='frm' id='frm' method='POST' action='./create.do' enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <div class='col-md-9'>
      <input type='text' name='qtitle' id='name' value='' required="required" autofocus="autofocus"  class='form-control'>
    </div>
  </div> 
  ...
  <div class="form-group">
    ...
    <div class='col-md-9'>
      <textarea name='qcontent' rows="" cols="" class='form-control' id='acontent'></textarea>
    </div>
  </div>
