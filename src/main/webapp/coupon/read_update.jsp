 ...
 <DIV class='title_line'>
  ...
  <DIV id='panel_create' style='padding: 10px 0px 10px 0px; background-color: #F9F9F9; width: 100%; text-align: center;'>
    <FORM name='frm_create' id='frm_create' method='POST' action='./update.do'>
      ...
      <label>쿠폰 이름</label>
      <input type='text' name='coupon_name' value='${couponVO.coupon_name}' required="required" style='width: 20%;'>
 
      <label>할인가</label>
      <input type='number' name='coupon_cost' value='${couponVO.coupon_cost}' required="required" style='width: 20%;'>
