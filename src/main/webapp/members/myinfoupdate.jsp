...
<table class="tbl_comm">
 <tbody>
  ...
  <tr class="fst">
   ...
   <td class="td_id">
   <input class="join_input" type="text" name="id" id="id" required="required" value="${sessionScope.id }" readonly >
   </td>
  </tr>
   ...
   <td class="td_passwd">
   <input class="join_input" type="password" name="passwd" id="passwd" required="required">
   </td>
  </tr>
  ...
  <tr>
   ...
   <td class="td_passwd2">
   <input class="join_input" type="text" name="mname" id="mname" required="required" value="${sessionScope.mname }">
   </td>
  </tr>
  ...
  <tr>
   ...
   <td class="td_passwd2">
   <input class="join_input" type="text" name="nickname" id="nickname" required="required" value="${sessionScope.nickname }">
  ...
  <tr>
   ...
   <td class="td_passwd2">
   <input class="join_input" type="text" name="email" id="email" required="required" value="${sessionScope.email }">
  ...
  <tr>
   ...
   <td class="td_passwd2">
   <input class="join_input" type="text" name="tel" id="tel" required="required" value="${sessionScope.tel }">
   </td>
  </tr>
  ...
  <tr>
   ...
   <td class="td_passwd2">
   <input class="join_input" type="text" name="zipcode" id="zipcode" value="${sessionScope.zipcode }">
  ...
  <tr>
   ...
   <td class="td_passwd2">
   <input class="join_input" type="text" name="address1" id="address1" value="${sessionScope.address1 }">
   </td>
  </tr>
  ...
  <tr>
   ...
   <td class="td_passwd2">
   <input class="join_input" type="text" name="address2" id="address2" value="${sessionScope.address2 }">
   </td>
  </tr>
...
<div id="form_submit" class="form_submit">
     ...
     <a href="/members/hack.jsp" class="hack_btn">탈퇴하기</a>
     <button id="btn_update" class="update_btn">회원정보수정</button>
</div>
