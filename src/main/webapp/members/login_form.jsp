  ...
  <FORM name='frm' method='POST' action='./login.do' class="form-horizontal">
    ...
    <div class="form-group">
      <div class="col-md-offset-2 col-md-10">
        ...
        <br>
        <button type='button' onclick="loadDefault();" class="btn btn-primary btn-md">아이디찾기</button>
        <button type='button' onclick="loadDefault();" class="btn btn-primary btn-md">비밀번호찾기</button>
      </div>
    </div>   
